    ...
    <div className="relative min-h-screen overflow-hidden bg-foreground">
        ...
        {!showContent && (
          <>
            ...
            <motion.div
              ...
              style={{
                background:
                  "linear-gradient(135deg, hsl(345 72% 22%), hsl(345 72% 32%), hsl(345 60% 25%))",
            ...
            >
              <div
                ...
                style={{
                  background:
                    "repeating-linear-gradient(90deg, transparent, transparent 40px, rgba(0,0,0,0.15) 40px, rgba(0,0,0,0.15) 42px, transparent 42px, transparent 80px)",
                }}
              />
              <div
                ...
                style={{
                  background:
                    "repeating-linear-gradient(90deg, transparent, transparent 60px, rgba(255,255,255,0.05) 60px, rgba(255,255,255,0.05) 62px)",
                }}
              />
            </motion.div>
            {/* Right curtain */}
      ...
      <section className="relative min-h-screen">
        ...
        <div className="relative z-10 flex min-h-[calc(100vh-80px)] flex-col items-center justify-center px-6 text-center">
          ...
          >
            Ваш проводник
            <br />в мир <span className="text-accent">театра</span>
          </motion.h1>
          ...
          >
            Анализируйте эмоциональные профили спектаклей, сравнивайте
            постановки и находите идеальное представление для любого настроения
          </motion.p>
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(180deg, hsl(20 14% 10%), hsl(20 14% 14%))",
        }}
      >
        <div className="mx-auto max-w-5xl">
          ...
          >
            <h2 className="font-display text-3xl font-bold text-primary-foreground md:text-4xl">
              Всё для идеального{" "}
              <span className="text-accent">вечера в театре</span>
            </h2>
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(180deg, hsl(20 14% 14%), hsl(20 14% 12%))",
        }}
      >
            ...
            {featured.map((p, i) => (
              ...
              >
                ...
                >
                  ...
                  <div className="p-4">
                    <h3 className="font-display text-base font-semibold text-primary-foreground line-clamp-1">
                      {p.title}
                    </h3>
                    <p className="mt-1 font-body text-xs text-primary-foreground/50 line-clamp-1">
                      {p.theater}
                    </p>
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(180deg, hsl(20 14% 12%), hsl(20 14% 15%))",
        }}
      >
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(135deg, hsl(345 72% 28%), hsl(345 72% 20%))",
        }}
      >
        ...
        >
          <h2 className="font-display text-3xl font-bold text-primary-foreground md:text-4xl">
            ...
            <br />
            минского <span className="text-accent">театра</span>
          </h2>
